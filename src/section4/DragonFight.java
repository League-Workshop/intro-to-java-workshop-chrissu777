...
public class DragonFight {
	...
	while(playerHealth>0 && dragonHealth>0) {    //this line of code keeps the battle going until someone's health reaches 0 
		...
		int damage=generator.nextInt(26);
		...
		int damage = generator.nextInt(35);
		...
		if(playerHealth<=0) {
			...
			JOptionPane.showMessageDialog(null, "You lost, you useless piece of trash.");
		speak("You lost, you useless piece of trash.");
		}
	   ...
	   //  15.  Else
		else JOptionPane.showMessageDialog(null, "Your health is "+playerHealth+"\n The dragon's health is"+dragonHealth);
